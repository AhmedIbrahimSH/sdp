...
class AddDrugsDonationView
{
    public function render()
    {
        ...
        <div style='width: 50%; margin: 50px auto; padding: 20px; border: 1px solid #ccc; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);'>
            <h2 style='text-align: center; color: #333;'>Add Drugs Donation</h2>
            <form method='POST' action='?action=addDrugsDonationSubmit' style='display: flex; flex-direction: column; gap: 15px;'>
