...
-- Create Need tables
 ...
 CREATE TABLE IF NOT EXISTS MedicalNeedHistory (
                                                   ...
                                                   Accepted BOOLEAN DEFAULT FALSE,
                                                   RegisterDate TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                                                   purpose  TEXT (255) DEFAULT 'Medical Assistance for Low Income beneficiary',
                                                   FOREIGN KEY (BeneficiaryID) REFERENCES Beneficiary(PersonID) ON DELETE CASCADE
 );
...
-- Insert storage data
 ...
 WHERE type = 'Cash' AND Amount >= 1000.00;
...
-- Insert John Doe
 INSERT INTO Person (FirstName, LastName, MiddleName, Nationality, Gender, Phone, AddressID)
 VALUES ('John', 'Doe', 'Michael', 'American', 'Male', '1234567890',  7);
 SET @last_PersonID = LAST_INSERT_ID();
 INSERT INTO Account (PersonID, Email, PasswordHashed,  IsUser, IsAccountDeleted)
...
-- Insert Jane Smith
 INSERT INTO Person (FirstName, LastName, MiddleName, Nationality, Gender, Phone, AddressID)
 VALUES ('Jane', 'Smith', NULL, 'British', 'Female', '0987654321', 8);
 SET @last_PersonID = LAST_INSERT_ID();
 INSERT INTO Account (PersonID, Email, PasswordHashed,  IsUser, IsAccountDeleted)
...
-- Insert Alex Taylor
 INSERT INTO Person (FirstName, LastName, MiddleName, Nationality, Gender, Phone, AddressID)
 VALUES ('Alex', 'Taylor', 'Lee', 'Canadian', 'Male', '1122334455', 9);
 SET @last_PersonID = LAST_INSERT_ID();
 INSERT INTO Account (PersonID, Email, PasswordHashed,  IsUser, IsAccountDeleted)
