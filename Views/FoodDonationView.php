                ...
                <tr>
                    ...
                    <td>
                        <button style='background-color: blue; color: white; padding: 5px; border: none;' 
                                onclick='window.location.href=\"?action=foodDonationUpdate&id={$donation['DonationID']}\"'>
                            Update
                        </button>
        ...
        <script>
            function confirmDeletion(donationID) {
                if (confirm('Are you sure you want to delete this donation?')) {
                    window.location.href = '?action=foodDonationDelete&id=' + donationID;
                }
            }
        </script>
        ";
